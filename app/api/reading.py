...
from app.services.audio.reading import ReadingAnalyzer
...
async def analyze_reading(
    ...
    """
    Upload a reading recording, measure reading velocity (WPM) and
    interruptions (pauses between speech segments), and store the
    result via Laravel.
    """
    ...
    return {
        "success": True,
        "message": "Reading exercise recorded successfully."
    }